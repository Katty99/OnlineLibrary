...
SECRET_KEY = 'django-insecure-uv#ke*ics5&b1@w4ke&#!^ah#p*7!a)4#bq(nqkp)wsps%gu-3'
...
INSTALLED_APPS = [
    ...
    'OnlineLibrary.account',
    'OnlineLibrary.book',
    'OnlineLibrary.common'
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'onlinelibrary-database',  # database name
